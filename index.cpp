...
int nhapNV(NV & listNV){
    ...
    while (!(cin >> maSoNV)) {
        cin.clear();
        cin.ignore(1000, '\n'); 
        cout << "Ma so nhan vien khong hop le, hay nhap lai!" << endl;
        cout<<"Nhap ma so nhan vien: ";
    }
    if(!checkNV(listNV,maSoNV)){
        cin.clear();
        cin.ignore(1000, '\n');
        cout<<"Khong ton tai nhan vien co ma so "<<maSoNV<<" ! Hay kiem tra lai."<<endl;
...
int nhapDT(DT &listDT){
    cout<<"Nhap ma so de tai: ";
    int maSoDT;
    // cin>>maSoDT;
    while (!(cin >> maSoDT)) {
        cin.clear();
        cin.ignore(1000, '\n'); 
        cout << "Ma so de tai khong hop le, hay nhap lai!" << endl;
        cout<<"Nhap ma so de tai: ";
    }
    if(!checkDT(listDT,maSoDT)){
        cin.clear();
        cin.ignore(1000, '\n');
        cout<<"Khong ton tai de tai co ma so "<<maSoDT<<" ! Hay kiem tra lai."<<endl;
        cout<<endl<<"Nhap phim bat ki de tiep tuc!";
        getch();
        return 0;
    }
...
void menuThemDuLieuListNV(NV &listNV){
    ...
    cout<<"Ho va ten dem: ";
        ...
        for(int i=0;i<hoDem.length();i++){
            if(hoDem[i]>='0'&&hoDem[i]<='9'){
                cout<<"Ho dem khong the chua chu so!"<<endl;
    ...
    cout<<"Ten: ";
        ...
        for(int i=0;i<ten.length();i++){
            if(ten[i]>='0'&&ten[i]<='9'){
                cout<<"Ten khong the chua chu so!"<<endl;
                cout<<"Vui long nhap lai. ";
                goto ten;
            }
            if(ten[i]==' '){
                cout<<"Ten khong the chua dau cach (ten chi la 1 tu)!"<<endl;
                cout<<"Vui long nhap lai. ";
                goto ten;
            }
        }
...
void menuThemDuLieuListDT(DT &listDT){
    ...
    cout<<"Nam bat dau: ";
        ...
        while (!(cin >> namBatDau)|| namBatDau >2023 || namBatDau<1000) {
            cin.clear();
            cin.ignore(1000, '\n'); 
            cout << "Nam bat dau khong hop le, hay nhap lai!" << endl;
            cout << "Nam bat dau: ";
        }
    cout<<"Nam ket thuc: ";
        int namKetThuc;
        ...
        while (!(cin >> namKetThuc)|| namKetThuc < 1000 ||namKetThuc<namBatDau) {
            if(namKetThuc<namBatDau ){
                cout<<endl<<"Nam ket thuc khong the nho hon nam bat dau. Hay nhap lai !"<<endl;
                cout<<"Nam ket thuc: ";
                cin.clear();
                cin.ignore(1000, '\n');
                continue;
            ...
            cin.clear();
            cin.ignore(1000, '\n'); 
            cout << "Nam ket thuc khong hop le, hay nhap lai!" << endl;
            cout << "Nam ket thuc: ";
        }
    cout<<"Kinh phi: ";
        long long kinhPhi;
        ...
        while (!(cin >> kinhPhi) || kinhPhi < 0) {
            cin.clear();
            cin.ignore(1000, '\n'); 
            cout << "Kinh phi khong hop le, hay nhap lai!" << endl;
            cout << "Kinh phi: ";
        }
    cout<<endl<<"Check thong tin: "<<endl;

        headerOutput("| Ma so DT ","|    Ten de tai    ","| Nam bat dau ","| Nam ket thuc ","|        Kinh phi        ","|","");
        string kinhPhiString=to_string(kinhPhi);
        ...
        cout<<" "<<kinhPhi;spaceLength("|        Kinh phi        ",2+kinhPhiString.length());	
        cout<<endl;
        headerOutLine("| Ma so DT ","|    Ten de tai    ","| Nam bat dau ","| Nam ket thuc ","|        Kinh phi        ","|","");
...
void menuXoaDuLieuListNVDT(NVDT &listNVDT,NV &listNV,DT &listDT){
    ...
    cout<<"Nhap ma so nhan vien: ";
        ...
        while(1){
            ...
            if(checkNVDT_NV(listNVDT,maSoNV)){
                ...
                cin.clear();
                cin.ignore(1000, '\n');
                cout<<"Nhan vien co ma so "<<maSoNV<<" khong tham gia de tai nao ! Hay kiem tra lai."<<endl;
                cout<<endl<<"Nhap phin bat ki de tiep tuc!";
                getch();
                return;
            }
        }

        cout<<"Cac de tai ma nhan vien co ma so "<<maSoNV<<" tham gia: "<<endl;
        headerOutput("| Ma so NV ","| Ma so DT ","|   Vai tro   ","","","|","");
        for(NhanVienDeTai *i=listNVDT.nvdtHead;i!=nullptr;i=i->next){
            if(i->maSoNV==maSoNV){
                cout<<"| "<<i->maSoNV;spaceLength("| Ma so NV ",2+intLength(i->maSoNV));
    ...
    cout<<"Nhap ma so de tai muon xoa: ";
        int maSoDT;
        // cin>>maSoDT;
        while (!(cin >> maSoDT)) {
            cin.clear();
        ...
        while(1){
            ...
            if(checkNVDT(listNVDT,maSoNV, maSoDT)){
                ...
                cin.clear();
                cin.ignore(1000, '\n');
                cout<<"Nhan vien co ma so "<<maSoNV<<" khong tham gia de tai "<<maSoDT<<" ! Hay kiem tra lai."<<endl;
                cout<<endl;"Nhap phin bat ki de tiep tuc!";
                getch();
                return;
            }
        }
    cout<<"Ban chac chan muon xoa nhan vien - de tai tren ?"<<endl;
    int check=luaChon("Xoa", "Huy","Nhap lai","","","");
    if(check==0){
        cin.ignore();
        cin.clear();
...
void menuXoaDuLieuListNV(NV &listNV, NVDT &listNVDT){
    ...
    cout<<"Ban chac chan muon xoa nhan vien tren ?"<<endl;
    int check=luaChon("Xoa", "Huy","Nhap lai","","","");
    if(check==0){
        cin.clear();
        cin.ignore();
...
void menuXoaDuLieuListDT(DT &listDT, NVDT &listNVDT){
    ...
    cout<<endl<<"Ban chac chan muon xoa de tai tren ?"<<endl;
    int check=luaChon("Xoa", "Huy","Nhap lai","","","");
    cout<<endl;
    if(check==0){
        cin.ignore();
        ...
        cout<<endl<<endl<<"Xoa de tai "<< maSoDT<<" thanh cong!"<<endl;
    }else if(check==1){
        cin.ignore();
        cin.clear();
    }else if(check==2){
        cout<<endl<<"Nhap lai: "<<endl;
        cin.clear();
        cin.ignore();
        goto nhapLaiXoaDT;
    }
...
void menuSuaDuLieuListDT(DT &listDT){
    ...
    switch(luachon){
        case 0:
            cout<<"Nhap ten de tai moi: ";
            getline(cin,newTenDeTai);
            break;
        case 1:
            cout<<"Nhap nam bat dau moi: ";
            while (!(cin >> newNamBatDau)|| newNamBatDau >2023 || newNamBatDau<1000 || newNamBatDau>newNamKetThuc) {
                if(newNamBatDau>newNamKetThuc){
                    cout<<endl<<"Nam bat dau khong the lon hon nam ket thuc !"<<endl;
                    cout<<endl<<"Nhap phim bat ki de tiep tuc.";
                    getch();
                    return;
                }
    ...
    headerOutput("| Ma so DT ","|    Ten de tai    ","| Nam bat dau ","| Nam ket thuc ","|        Kinh phi        ","|","");
    string kinhPhiString=to_string(newKinhPhi);
    cout<<"| "<<maSoDT;spaceLength("| Ma so DT ",2+intLength(maSoDT));
    ...
    cout<<" "<<kinhPhiString;spaceLength("|        Kinh phi        ",2+kinhPhiString.length());	
    cout<<endl;
    headerOutLine("| Ma so DT ","|    Ten de tai    ","| Nam bat dau ","| Nam ket thuc ","|        Kinh phi        ","|","");
...
void menuSuaDuLieuListNVDT( NV &listNV, DT &listDT,NVDT &listNVDT){
    ...
    cout<<"Nhap ma so de tai muon chinh sua: ";
        int maSoDT;
        // cin>>maSoDT;
        while (!(cin >> maSoDT)) {
            cin.clear();
    ...
    headerOutput("| Ma so NV ","| Ma so DT ","|   Vai tro   ","","","|","");
        ...
        cout<<endl;
        int check=luaChon("Cap nhat","Huy","Nhap lai","","","");;
    if(check==0){
...
void yeuCau3(NV &listNV,NVDT &listNVDT){
    system("cls");
    cout<<"Cho biet danh sach de tai ma nhan vien nay tham gia la thu ki/ chu nhiem."<<endl;
    cout<<"Nhap ma so nhan vien: ";
        int maSoNV;
        // cin>>maSoNV;
        while (!(cin >> maSoNV)) {
...
void yeuCau5(NV &listNV,DT &listDT,NVDT &listNVDT){
    ...
    for(NhanVienDeTai *i=listNVDT.nvdtHead;i!=nullptr;i=i->next){
        if(i->maSoDT==dt->maSoDT && (i->vaiTro=="Chu nhiem" || i->vaiTro=="Thu ki")){
            ...
            if(i->vaiTro=="Chu nhiem"){
                chuNhiem=nv->hoDem+" "+nv->ten;
            }
            if(i->vaiTro=="Thu ki"){
                thuKi=nv->hoDem+" "+nv->ten;
            }
        }
    ...
    cout<<endl<<"Thong tin chi tiet cua de tai "<<maSoDT<<" :"<<endl;
    ...
    if(soThanhVien==0){
        ...
        cout<<"Danh sach thanh vien cua de tai "<<maSoDT<<" :"<<endl;
        headerOutput("| Ma so NV ","|    Ho ten dem    ","|   Ten   ","|  Gioi tinh  ","|     Ngay sinh     ","|","");
        for(NhanVienDeTai *i=listNVDT.nvdtHead;i!=nullptr;i=i->next){
            if(i->maSoDT==dt->maSoDT && i->vaiTro=="Thanh vien"){
                nv=searchNV(listNV,i->maSoNV);
...
void yeuCau6(NV &listNV,DT &listDT,NVDT &listNVDT){
    ...
    //in ket qua
    if(!checkNamBatDau){
        cout<<"Khong co de tai nao bat dau trong nam "<<namBatDau<<". "<<endl;
        cout<<endl<<"Nhap phim bat ki de tiep tuc.";
        getch();
        cin.clear();
        cin.ignore();
    ...
    int sumKinhPhi=0;
    cout<<endl<<"Danh sach de tai bat dau trong nam "<<namBatDau<<" :"<<endl;
    headerOutput("| Ma so DT ","|    Ten de tai    ","| Nam bat dau ","| Nam ket thuc ","|        Kinh phi        ","|","");
    for(DeTai *i=listDT.dtHead;i!=NULL;i=i->next){
        if(i->namBatDau==namBatDau){
            string kinhPhi=to_string(i->kinhPhi);
    ...
    cout<<"Tong kinh phi cua nhung de tai bat dau nam "<<namBatDau<<" la: "<<sumKinhPhi;
    cout<<endl;
    cout<<endl<<"Nhap phim bat ki de tiep tuc.";
    getch();
    cin.clear();
